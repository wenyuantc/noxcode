  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="inline-flex h-7 max-w-48 cursor-pointer items-center justify-between gap-1.5 rounded-lg border border-border/70 bg-background/80 px-2 text-xs font-medium text-foreground/90 shadow-2xs transition-all duration-150 outline-none hover:bg-muted/40 disabled:opacity-60"
      >
