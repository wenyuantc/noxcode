...
**noxcode** is a Tauri v2 desktop app: an in-process native Agent with AI channels, SSH workspaces, and Git checkpoints. Architecture: `docs/architecture.md`. Database schema: `docs/database.md`. SSH: `docs/ssh.md`. Git: `docs/git.md`. Channels: `docs/channels.md`. Native runtime: `docs/native.md`. Full build plan: `plan.md`.
